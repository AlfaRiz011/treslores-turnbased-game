...
public class MagicianState : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Spawn();
        UpdateStats();
        healthBar.SetMaxHealth(MagicianBase.MaxHP);
    ...
    void doDamage()
    {
        float calc_damage = MagicianBase.ATK + BSM.PerformList[0].choosenAttack.attackDamage;
